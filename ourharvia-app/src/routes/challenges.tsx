...
import { Flame, Target, Users, Calendar, Trophy, Zap, ChevronRight, Lock, CheckCircle2, Clock, TrendingUp, Award, Star, Heart } from 'lucide-react'
              ...
              >
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex justify-between">
                    <p style={{ color: '#999' }} className="text-xs">PROGRESS</p>
                ...
                <div className="space-y-4 mb-6 pb-4 border-b" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
                  {selectedChallenge.daysLeft > 0 && (
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span style={{ color: '#999' }} className="text-sm">Time remaining</span>
                      </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span style={{ color: '#999' }} className="text-sm">Reward</span>
                    </div>
                  ...
                  {selectedChallenge.requirement && (
                    <div>
                      <p style={{ color: '#999' }} className="text-xs mb-2">REQUIREMENT</p>
                  ...
                  {selectedChallenge.participants && selectedChallenge.participants.length > 0 && (
                    <div>
                      <p style={{ color: '#999' }} className="text-xs mb-2">PARTICIPANTS</p>
